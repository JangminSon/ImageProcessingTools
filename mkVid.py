...
arg_parser.add_argument("-e", "--extension", required=False, default='jpg', help="Extension name. default is 'png'.")
arg_parser.add_argument("-d", "--directory", required=False, default='./tfOut', help="Specify image directory.")
arg_parser.add_argument("-fps", "--framerate", required=False, default='30', help="Set the video framerate.")
...
arg_parser.add_argument("-t", "--time", required=False, default='13', help="Sets the framerate so that the video length matches the time in seconds.")
...
out = cv2.VideoWriter('vid_'+dir_path[2:]+'.mp4', fourcc, 29.97, (width, height))
